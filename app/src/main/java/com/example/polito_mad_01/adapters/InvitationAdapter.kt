...
class InvitationAdapter(private val data:List<Invitation>, private val navController: NavController): RecyclerView.Adapter<InvitationHolder>(){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): InvitationHolder{
        ...
        return InvitationHolder(v, navController)
    }
...
class InvitationHolder(private val v: View, private val navController: NavController): RecyclerView.ViewHolder(v){
